...
Policy measures against binge drinking applied in Baden-Wuerttemberg (night sales ban on alcohol): How effective?

Correlation with economic situation?
...
for (i in 1:12){
  F100Plot <- add_trace(F100Plot, 
                        ...
                        line = list(color = colorRampPalette(brewer.pal(9, "Reds"))(12)[i], width = 2))
}
# City States
for (i in 1:3){
  F100Plot <- add_trace(F100Plot, 
                        ...
                        line = list(color = colorRampPalette(brewer.pal(5, "Blues"))(5)[i+2], width = 4),
                        name = paste("City State", substr(statelist_cities[i], 4, 5)))
}
F100Plot

#layout(F100Plot, title = "TITLE", font = list(#family = "Courier New, monospace",
#                                              size = 10,
#                                              color = "#000000"))
...
#        axis.title.y=element_text(margin=margin(10,10,0,10)))
  ...
  #annotate("text", x = 0, y = 0.1, label = "Label", parse = TRUE)
```
