...
stargazer::stargazer(mod3.16, mod3.13, 
                     ...
                     covariate.labels = c("DE-BW dummy", "Post-treatment dummy", "Night-Sale Ban", "(Intercept)"),
                     model.numbers  = FALSE,
