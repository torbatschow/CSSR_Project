...
ggplot(data=filter(DS0, STATE == "DE-DE"), aes(x = YEAR, colour = Diagnoses)) +
  ...
  xlab("Years") +                            
  ylab("Diagnoses\nper 1000 pp") +
  ggtitle("F10.0, F10.2, and K70 diagnoses\nin Germany 2000-2014") +
...
ggplot(data=DS2, aes(x = YEAR, y = F100_p1000, group = STATE, colour = GROUP)) +
  scale_x_continuous(breaks = c(2000, 2005, 2010, 2014), minor_breaks = c(2000:2014)) +
  geom_line(aes(group = STATE), size = 1) +        # line plot
  theme_bw() +                               # bw background
  scale_color_manual("State", values = c(cbbPalette[6], cbbPalette[1], cbbPalette[7])) +
  xlab("Years") +
  ylab("F10.0 diagnoses per 1000 inhabiants \nfor 15-19-year-olds") +
  ggtitle("F10.0 diagnoses for 15-19-year-olds\nin German states 2000-2014") +
#  scale_color_discrete(name  = "State", breaks = statelist_code, labels = statelist.code.short) +
...
ggplot(data=DS2, aes(x = YEAR, colour = GROUP)) +
  scale_x_continuous(breaks = c(2000, 2005, 2010, 2014), minor_breaks = c(2000:2014)) +
  geom_line(data=filter(DS2, GROUP == "Non-City"), aes(y = F100_p1000, group = STATE), size = 1) +
