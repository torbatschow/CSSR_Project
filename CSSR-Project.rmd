...
# First results
The first model is simple and its results are at maximum indicative. It does reveal to which state charateristics short-term alcoholrelated hospitalizations (ST-ARH) are correlated. We find that ST-ARH are higher in states with a lower GDP. This captures the basic intuition that binge dringing is more common in economically less well of regions. But this view is not confirmed by our second indicator for economic well-being: the unemployment rate. Rather contrary, states with higher unemployment rates have less cases of binge drinking. Finally, we find correlation between beer consumption (approximated by the beer tax revenue) and ST-ARH. These results are robust over all years of our investgation. But this result is only indicative since the data set is small and we are looking at an strongly aggregated level. Most likely there are many different things happpening which we cannot observe with this data.
