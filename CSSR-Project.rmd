...
# font_import("cmr10")
ggplot(data=filter(DS0, STATE == "DE-DE"), aes(x = YEAR)) +
  scale_x_continuous(breaks = c(2000, 2005, 2010, 2014), minor_breaks = c(2000:2014)) +
  geom_line(aes(y = F100_p1000, colour = "red")) +
  geom_line(aes(y = K70_p1000, colour = "black")) +                              # line plot
  geom_line(aes(y = F102_p1000, colour = "blue")) +
