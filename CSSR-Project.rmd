...
But again the result should be treated with care. The calculations are based on 195 observations, which are due to reduced control group and the exact estimate is varying with the different control group compositions. 

# Conclusion

Overall, our research supports the general conclusion of the literature on drinking and socio-economic factors. In particular, the most sophisticated approach (model 5) we used finds that higher youth unemployment is correlated with more alcohol-related diagnoses amoung young people and that the night sales ban on alcohol has a measurable negative effect on binge-drinking. But due to the limitations of our data this finding is not always consistent over the models we used. In case of a contradiction between our finding and the general view we attributed the short-coming to a short-coming of our model.

As our study reengenered @Marcus.2015 the confirmation of their general result deserves particular attention. 

Further improve the research by getting disaggregated data sets. @Marcus.2015 still lacks a relative short observation horizon and more thorough investigation of the mid-term effects would bring an added value.

include more control variables
many are not available as time-series or only cover certain years
we had to exclude 
