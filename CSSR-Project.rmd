...
```
The major draw back of this regression is the low number of observations. With one observation per state the standard error are huge. In the second step we increased our data set by looking at difference over time, which increases the number of available observations to 224:
